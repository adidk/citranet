          ...
          <div class="p-5">
            ...
            <form method="post" action="<?= base_url() ?>auth/regristation" class="user">
              ...
              <label class="col-sm-2 col-form-label">Password</label>
                  <input type="password" class="form-control mb-3 form-control-user" id="password1" name="password1" placeholder="Password">
                  <?php echo form_error('password1', '<small class="text-danger pl-3">', '</small>'); ?>
                  <input type="password" class="form-control mb-3 form-control-user" id="password2" name="password2" placeholder="Ulangi Password">
